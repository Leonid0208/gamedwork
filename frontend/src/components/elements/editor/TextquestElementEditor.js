...
function TextquestElementEditor({shapeProps, isSelected, onSelect, onTextEdit, onChange}) {
                        ...
                        {shapeProps?.curText === i && (
                            <Text
                                ...
                                dragBoundFunc={(pos) => {
                                    ...
                                    else if (pos.x > shapeProps.x + mainWidth * 0.1 + shapeProps.unit.width - textRef.current.width())
                                        newX = shapeProps.x + mainWidth * 0.1 + shapeProps.unit.width - textRef.current.width();
                                    else
                                        newX = pos.x;
                                    ...
                                    else if (pos.y > shapeProps.y + mainHeight * 0.05 + shapeProps.unit.height - textRef.current.height())
                                        newY = shapeProps.y + mainHeight * 0.05 + shapeProps.unit.height - textRef.current.height();
                                    else
                                        newY = pos.y;
                        ...
                        {shapeProps.units[shapeProps.curText]?.buttons?.map((eachButton, i) => (
                            <Group
                                ...
                                dragBoundFunc={(pos) => {
                                    ...
                                    if (pos.x < shapeProps.x + mainWidth * 0.1)
                                        newX = shapeProps.x + mainWidth * 0.1;
                                    else if (pos.x > shapeProps.x + mainWidth * 0.1 + shapeProps.unit.width - shapeProps.button.width)
                                        newX = shapeProps.x + mainWidth * 0.1 + shapeProps.unit.width - shapeProps.button.width;
                                    else
                                        newX = pos.x;
                                    ...
                                    if (pos.y < shapeProps.y + mainHeight * 0.05)
                                        newY = shapeProps.y + mainHeight * 0.05;
                                    else if (pos.y > shapeProps.y + mainHeight * 0.05 + shapeProps.unit.height - shapeProps.button.height)
                                        newY = shapeProps.y + mainHeight * 0.05 + shapeProps.unit.height - shapeProps.button.height;
                                    else
                                        newY = pos.y;
